/**
 * @file
 * Provides UI/UX progressive enhancements on drupak's theme settings by
...
((Drupal, settings, once) => {
  const colorSchemeCategories = settings.drupak.colorSchemes || {};
  ...
  function synchronizeInputs(changedInput, inputToSync) {
    ...
    const colorSchemeSelect = changedInput.closest('details')?.querySelector('[data-drupal-selector="edit-drupak-color-scheme"]');
   ...
   *
   * @param {HTMLSelectElement} selectElement div[data-drupal-selector="edit-drupak-color-scheme"]
   */
  ...
  /**
   * Initializes drupak theme-settings color picker.
  ...
  function initColorPicker(textInput) {
    ...
    colorInput.setAttribute(
      'data-drupak-custom-color',
      textInput.getAttribute('data-drupak-custom-color'),
    );
  ...
  /**
   * drupak Color Picker behavior.
   *
   * @type {Drupal~behavior}
   * @prop {Drupal~behaviorAttach} attach
   *   Initializes color picker fields.
   */
  Drupal.behaviors.drupakColorPicker = {
    attach: () => {
      const colorSchemeSelects = once(
        'drupak-color-picker',
        '[data-drupal-selector^="edit-drupak-color-scheme"]',
      );
      ...
      const colorTextInputs = once(
        'drupak-color-picker',
        '[data-drupal-selector="drupak-color-picker"] input[type="text"]',
      );
