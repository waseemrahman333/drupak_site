/**
 * @file
 * Provides UI/UX progressive enhancements on tailpine_starterkit's theme settings by
...
((Drupal, settings, once) => {
  const colorSchemeCategories = settings.tailpine_starterkit.colorSchemes || {};
  ...
  function synchronizeInputs(changedInput, inputToSync) {
    ...
    changedInput.setAttribute(
      'data-tailpine_starterkit-custom-color',
    ...
    const colorSchemeSelect = changedInput.closest('details')?.querySelector('[data-drupal-selector="edit-tailpine_starterkit-color-scheme"]');
   ...
   *
   * @param {HTMLSelectElement} selectElement div[data-drupal-selector="edit-tailpine_starterkit-color-scheme"]
   */
  ...
  /**
   * Initializes tailpine_starterkit theme-settings color picker.
  ...
  function initColorPicker(textInput) {
    ...
    colorInput.setAttribute(
      'data-tailpine_starterkit-custom-color',
      textInput.getAttribute('data-tailpine_starterkit-custom-color'),
    );
  ...
  /**
   * tailpine_starterkit Color Picker behavior.
   *
   * @type {Drupal~behavior}
   * @prop {Drupal~behaviorAttach} attach
   *   Initializes color picker fields.
   */
  Drupal.behaviors.tailpine_starterkitColorPicker = {
    attach: () => {
      const colorSchemeSelects = once(
        'tailpine_starterkit-color-picker',
        '[data-drupal-selector^="edit-tailpine_starterkit-color-scheme"]',
      );
      ...
      const colorTextInputs = once(
        'tailpine_starterkit-color-picker',
        '[data-drupal-selector="tailpine_starterkit-color-picker"] input[type="text"]',
      );
